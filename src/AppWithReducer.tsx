...
import {
    ActionsTypes, addTodolistAC,
    changeTodolistFilterAC,
    changeTodolistTitleAC,
    removeTodolistAC,
    todolistReducer
} from "./state/todolist-reducer";
import {addTaskAC, changeTaskStatusAC, changeTasksTitleAC, removeTaskAC, tasksReducer} from "./state/tasks-reducers";
...
function AppWithReducer(): JSX.Element {
    ...
    const [todolists, dispatchTodolists] = useReducer<Reducer<Array<TodolistType>, ActionsTypes>>(todolistReducer, [
    ...
    const changeTaskTitle = (taskId: string, title: string, todolistId: string) => {
        dispatchTasks(changeTasksTitleAC(taskId, title, todolistId))
    }
